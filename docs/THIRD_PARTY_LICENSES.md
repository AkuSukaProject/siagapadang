...
Daftar ini diperbarui setiap kali dependensi ditambahkan atau dihapus.

| Komponen | Versi | Fungsi | Lisensi |
|---|---:|---|---|
| Android Gradle Plugin | 8.13.2 | Sistem build Android | Apache License 2.0 |
| Kotlin | 2.3.21 | Bahasa dan compiler | Apache License 2.0 |
| Jetpack Compose BOM | 2026.02.01 | Keselarasan versi pustaka Compose | Apache License 2.0 |
| AndroidX Activity Compose | 1.12.4 | Host Activity untuk Compose | Apache License 2.0 |
| AndroidX Lifecycle | 2.10.0 | Integrasi lifecycle Android | Apache License 2.0 |
| MapLibre Native Android | 13.4.1 | Render peta dan polyline | BSD 2-Clause |
| AndroidX Room | 2.8.4 | Akses basis data lokal | Apache License 2.0 |
