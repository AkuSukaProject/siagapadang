...
HMAC_SECRET_VALUE = os.getenv("HMAC_SECRET")
if not HMAC_SECRET_VALUE:
    raise RuntimeError(
        "HMAC_SECRET belum diatur. Gunakan nilai acak yang disimpan di backend/.env."
    )
HMAC_SECRET = HMAC_SECRET_VALUE.encode("utf-8")
